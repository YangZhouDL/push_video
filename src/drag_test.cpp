...
int main(int argc, char *argv[])
{
    ...
    const char *in_filename = "rtmp://1.116.137.21:7788/zedm"; //芒果台rtmp地址
    const char *out_filename_v = "/home/redwall/catkin_ws/src/push_video/log/test.h264";                            // Output file URL
    // Register
    av_register_all();
    // Network
